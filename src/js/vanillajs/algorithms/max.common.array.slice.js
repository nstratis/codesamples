...
(function(){
  ...
  function execute(){
    ...
    consecIndex = 0, val1 = null, val2 = null, maxLen = 0, selIndex;
    ...
    for(i=0; i<length; i++){
      ...
      if(i === 0){
        ...
        if(blocks[blockIndex] === undefined){ blocks[blockIndex] = {i:i, grp:[]}; }
    ...
    for(i=0; i<length; i++){
      ...
      if(i === 0){
        ...
        consec[consecIndex] = {i:blocks[0].i, grp:blocks[0].grp};
        // Set the value 1
        val1 = blocks[0].grp[0];
      } else {
