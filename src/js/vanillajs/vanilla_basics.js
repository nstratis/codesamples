/*global console*/
/*jslint unparam:true, white:true, vars:true */
(function(){
  'use strict';
  ...
  */
  var myObj = (function(){
    ...
    // Private function
    function privateFnc(){ return 'I am a private fnc'; }
    ...
    return {
        ...
        // Public function
        publicFnc:function(){ return 'I am a public fnc'; }
    };
  }());
  ...
  */
  ...
  // Default object 1
  var firstObject = {
    firstMethod:function(){ return 'First Object'; },
    randomNonsense:{ what:'when' }
  };
  // Default object 2
  var secondObject = {
    secondMethod:function(){ return 'Second Object'; }
  };
  ...
  // Given there is no prototypal chaining I shall forgoe Object.create and stick with 'new' for the purpose of this demonstration
  var obj = new MyObj();
  // Check to determine if it is accessible
  if(obj.privateVar === undefined){ console.log('privateVar is not accessible'); }
  ...
  obj = new MyObj2();
  if(obj.publicVar === 'I am public'){ console.log('publicVar is an accessible property'); }
  console.log(myObj.publicVar); // outputs I am public
  ...
  if(typeof obj.privateFnc !== 'function'){ console.log('privateFnc() is not accessible'); }
  console.log(myObj.privateFnc); // outputs undefined

  // Extending the example above you could fundamentally create a public function utilizing the private function thus enforcing a “protected” state
  function MyObj4(){
    // Nested function
    function privateFnc(){
      return true;
  ...
  if(typeof obj.protectedFnc === 'function'){ console.log('protectedFnc() is accessible'); }

  console.log(myObj.publicFnc); // outputs fnc()
  // This is already implemented as the protected function above or alternatively it could be written as:
  ...
  if(typeof obj.publicFnc === 'function'){ console.log('publicFnc() is accessible'); }

  // Ultimately if you like short hand you could potentially use an anonymous function to bind the prototype functions, although this doesn't lint very well
  // (function() {
