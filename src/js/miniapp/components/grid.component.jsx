...
/**
 * @class DisplayGrid
 * @description A sample React JS DisplayGrid Component
 */
class DisplayGrid extends React.Component {

  /**
   * @function constructor
   * @memberof DisplayGrid
   * @description The constructor function for the DisplayGrid component
   */
  constructor(props){
   ...
   * @function render
   * @memberof DisplayGrid
   * @description Render the DisplayGrid component
   */
  render(){
 ...
 * @description The aim.DisplayGrid reference object for creating new instances
 */
app.displaygrid = (function(){
  return {
    create:function(parent, options){
      ...
      let grid = <DisplayGrid data={options.data} classArray={options.classArray} parent={parent} />;
      // Render the menu in the dom
      grid = ReactDOM.render(grid, pNode);
      // // Return the DisplayGrid object for referencing
      return grid;
    }
  }
}());
